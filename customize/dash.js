function init() {
                            ...
                            if(err) { 
                                ...
                                try{
                                    if(datadtl.Count>0) {
                                        ...
                                        console.log('XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
                                        console.log('mtype=>' + mtype + '<');
                                        switch(mtype) {
                                            case 'avg_pg_ld' : 
                                                console.log('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
                                                makePageLineChart(mtype,items);
                                                break;                                            
                                            case 'hourly_events' :
                                            ...
                                            case 'event_count' :
                                                ...
                                                break;
                                            default :
                                                console.log('unhandled metric type [' + mtype + ']');
                                                break;
                                        }
    ...
    var page_chart_time_ticks = [];
    var page_chart_dataset_data = [];
    var page_chart_time_ticks_display = [];

    function makePageLineChart(mtype,items){
        dt = new Date(items[0].EVENTTIMESTAMP);
        //if there are no ticks or if the tick is not already in the array, add it
        if(page_chart_time_ticks.length == 0 || page_chart_time_ticks.indexOf(items[0].EVENTTIMESTAMP)==-1){
            page_chart_time_ticks_display.push(dt.toTimeString().split(' ')[0]);
            page_chart_time_ticks.push(items[0].EVENTTIMESTAMP);
            page_chart_dataset_data.push(items[0].UNITVALUEINT);
        }
        if(page_chart_time_ticks.length>20){ //cull data over 20 data points
            page_chart_time_ticks.shift();
            page_chart_time_ticks_display.shift();
            page_chart_dataset_data.shift();
        }

        //build the data for the chart
        var chart_dataset = [{  
            label: "Average Page Load Time by Minute",
            fill: true, 
            spanGaps: true,
            backgroundColor: "rgba(155,253,10,0.4)",
            borderColor: "rgba(155,253,10,0.4)",    
            data: page_chart_dataset_data 
        }];
        ...
        var config = {
            type: "line",
            data: {labels: page_chart_time_ticks_display , datasets: chart_dataset }, 
            options: {
                legend: {
                    display: false
                },
